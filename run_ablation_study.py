...
# ── 분석 대상 종목 ─────────────────────────────────────────────────────────────
# 교수님 피드백: 국내 종목 위주로, 너무 많이 할 필요 없음
STOCKS = {
...
def run_ablation():
    ...
    save_path = "results/ablation/ablation_results.csv"
    ...
    fig.tight_layout()
    fig.savefig("results/ablation/ablation_rmse_plot.png", bbox_inches="tight")
    plt.close(fig)
    ...
    if importance_accum:
        ...
        fig2.tight_layout()
        fig2.savefig("results/ablation/feature_importance_avg.png", bbox_inches="tight")
        plt.close(fig2)
