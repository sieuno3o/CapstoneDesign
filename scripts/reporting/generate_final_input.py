...
def main():
    survey_path = str(BASE_DIR / "data/raw/survey.csv")
    news_path   = str(BASE_DIR / "data/sentiment/macro_news_counts_90d.csv")
    output_path = str(BASE_DIR / "data/sentiment/final_input.csv")
